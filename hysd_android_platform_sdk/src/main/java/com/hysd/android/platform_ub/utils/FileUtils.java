package com.hysd.android.platform_ub.utils;
...
public final class FileUtils {
	...
	/**
	 * return z_bg_home3 file based on the mFileUri that always has the format file://xyz/xyz
	 */
	...
	private static void initMIMEMapping() {
		...
		FILE_MIME_MAPPING.put("asf", "video/icon_eth-ms-asf");
		FILE_MIME_MAPPING.put("avi", "video/icon_eth-msvideo");
		...
		FILE_MIME_MAPPING.put("gtar", "application/icon_eth-gtar");
		FILE_MIME_MAPPING.put("gz", "application/icon_eth-gzip");
		...
		FILE_MIME_MAPPING.put("js", "application/icon_eth-javascript");
		FILE_MIME_MAPPING.put("log", "text/plain");
		FILE_MIME_MAPPING.put("m3u", "audio/icon_eth-mpegurl");
		...
		FILE_MIME_MAPPING.put("m4v", "video/icon_eth-m4v");
		FILE_MIME_MAPPING.put("mov", "video/quicktime");
		FILE_MIME_MAPPING.put("mp2", "audio/icon_eth-mpeg");
		FILE_MIME_MAPPING.put("mp3", "audio/icon_eth-mpeg");
		FILE_MIME_MAPPING.put("aac", "audio/icon_eth-mpeg");
		...
		FILE_MIME_MAPPING.put("rar", "application/icon_eth-rar-compressed");
		...
		FILE_MIME_MAPPING.put("tar", "application/icon_eth-tar");
		FILE_MIME_MAPPING.put("tgz", "application/icon_eth-compressed");
		FILE_MIME_MAPPING.put("txt", "text/plain");
		FILE_MIME_MAPPING.put("wav", "audio/icon_eth-wav");
		FILE_MIME_MAPPING.put("wma", "audio/icon_eth-ms-wma");
		FILE_MIME_MAPPING.put("wmv", "video/icon_eth-ms-wmv");
		FILE_MIME_MAPPING.put("wps", "application/vnd.ms-works");
		FILE_MIME_MAPPING.put("xml", "text/xml");
		FILE_MIME_MAPPING.put("xml", "text/plain");
		FILE_MIME_MAPPING.put("z", "application/icon_eth-compress");
