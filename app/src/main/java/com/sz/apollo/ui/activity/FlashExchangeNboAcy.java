 ...
 * 闪兑NBO
 */
public class FlashExchangeNboAcy extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flash_exchange_nbo);
        ...
        switch (message.what) {
            ...
            case GlobalMessageType.RequestCode.FLASH_RATE:
                ...
                if (null != flashRateBean) {
                    ...
                    tvNowRate.setText("1USDT = " + rate + " " + Constant.TYPE_NBO);
                }
                break;
    ...
    private void initView() {
        ...
        iRequest.queryFlashRate(Constant.TYPE_U, Constant.TYPE_NBO);
        edContent.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (StringUtils.isEmpty(s.toString()) || s.toString().equals(".") || Double.parseDouble(s.toString()) < 1) {
                    tvMaxExchange.setText("0 NOB");
                } else {
                    double content = Double.parseDouble(s.toString());
                    tvMaxExchange.setText(Util.getStringFromDecimal(content * rate, 4) + " NOB");
                }
            }
    ...
    public void onViewClicked(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_right:
                ...
                UiHelper.startFlashRecordAcy(this, Constant.TYPE_NBO);
                break;
        }
