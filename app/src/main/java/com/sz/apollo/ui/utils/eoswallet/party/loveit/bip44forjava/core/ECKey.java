...
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils.LinuxSecureRandom;
...
public class ECKey implements EncryptableItem {
     ...
     *
     * <p>See {@link } for example usage.</p>
     *
    ...
    public static boolean encryptionIsReversible(ECKey originalKey, ECKey encryptedKey, KeyCrypter keyCrypter, KeyParameter aesKey) {
        try {
            ...
            if (!Arrays.equals(originalPrivateKeyBytes, rebornKeyBytes)) {
                System.out.println("The check that encryption could be reversed failed for {}" + originalKey);
                return false;
            }
            return true;
