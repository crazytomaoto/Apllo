package com.sz.apollo.ui.utils.eoswallet.io.bigbearbro.eos4j.crypto;
...
import com.sz.apollo.ui.utils.eoswallet.io.bigbearbro.eos4j.client.transaction.TransactionToSign;
import com.sz.apollo.ui.utils.eoswallet.io.bigbearbro.eos4j.crypto.util.Base58;
import com.sz.apollo.ui.utils.eoswallet.io.bigbearbro.eos4j.crypto.util.Ripemd160;
...
import com.sz.apollo.ui.utils.eoswallet.io.bigbearbro.eos4j.utils.ByteUtils;
...
public class EccTool {
	...
	public static String privateKeyFromSeed(byte[] seed) {
		return privateKeyFromBigInteger(new BigInteger(seed));
	}
	...
	public static String privateToPublic(String pk) {
		...
		byte[] pub_buf = ep.getEncoded(true);
