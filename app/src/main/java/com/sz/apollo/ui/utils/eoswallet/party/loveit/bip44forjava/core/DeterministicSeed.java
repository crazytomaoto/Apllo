...
package com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.core;


import com.google.common.base.Objects;
import com.google.common.base.Splitter;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.crypto.EncryptableItem;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.crypto.EncryptedData;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.crypto.KeyCrypter;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils.MnemonicCode;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils.MnemonicException;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils.Utils;
...
import static com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils.Utils.HEX;

/**
 * Holds the seed bytes for the BIP32 deterministic wallet algorithm, inside a
 * {@link }. The purpose of this wrapper is to simplify the encryption
 * code.
 */
public class DeterministicSeed implements EncryptableItem {
    ...
    private byte[] getMnemonicAsBytes() {
        return Utils.SPACE_JOINER.join(mnemonicCode).getBytes(Charset.forName("UTF-8"));
    }
    ...
    private static List<String> decodeMnemonicCode(byte[] mnemonicCode) {
        return decodeMnemonicCode(new String(mnemonicCode, Charset.forName("UTF-8")));
    }
