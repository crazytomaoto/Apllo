...
package com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.utils;



import com.google.common.base.Stopwatch;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.core.Sha256Hash;
import com.sz.apollo.ui.utils.eoswallet.party.loveit.bip44forjava.crypto.PBKDF2SHA512;
...
public class MnemonicCode {
    ...
    static {
        try {
            ...
            if (!Utils.isAndroidRuntime())
                System.out.println("Could not find word list" + e);
        } catch (IOException e) {
            System.out.println("Failed to load word list" + e);
        }
    }

    /** Initialise from the included word list. Won't work on Android. */
    public MnemonicCode() throws IOException {
        wordList = Arrays.asList(EnglishWords.englishWords);
   ...
   /* public MnemonicCode(InputStream wordstream, String wordListDigest) throws IOException, IllegalArgumentException {
        BufferedReader br = new BufferedReader(new InputStreamReader(wordstream, Charset.forName("UTF-8")));
