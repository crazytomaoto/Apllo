...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ContactAddressBeanDao.createTable(db, ifNotExists);
        TestBeanDao.createTable(db, ifNotExists);
        UserWalletBeanDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        ContactAddressBeanDao.dropTable(db, ifExists);
        TestBeanDao.dropTable(db, ifExists);
        UserWalletBeanDao.dropTable(db, ifExists);
    }
