...
public class BasePopupWindow extends PopupWindow {
     ...
     * @param view
     */
    public void getViewRootMeasure(View view) {
        //获取自身的长宽高
    ...
    public View parent;
    public void setLocationOnScreen(View parent) {
        this.parent=parent;
        //获取需要在其上方显示的控件的位置信息
        location = new int[2];
    ...
    public void showAtLocationTop(BasePopupWindow popupWindow) {
        //显示在上方中心位置 设置显示在v上方（以v的中心位置为开始位置）
        popupWindow.showAtLocation(parent, Gravity.NO_GRAVITY, (location[0] + parent.getWidth() / 2) - popupWidth / 2, location[1] - popupHeight);

    }

    public void showAtLocationLeft(BasePopupWindow popupWindow) {
        //在控件上方显示 设置显示在v上方(以v的左边距为开始位置)
        popupWindow.showAtLocation(parent, Gravity.NO_GRAVITY, (location[0] + parent.getWidth() / 2) - popupWidth / 2, location[1] - popupHeight);
    }
}